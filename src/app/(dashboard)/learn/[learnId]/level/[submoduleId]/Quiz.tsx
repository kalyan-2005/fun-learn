...
// const Quiz = ({ questions, currentUser, params }: { questions: any[]; currentUser: any; params?: { submoduleId: string } }) => {
//   const router = useRouter();
//   const [index, setIndex] = useState(0);
//   const [currentQuestion, setCurrentQuestion] = useState(questions[index]);
//   const [score, setScore] = useState(0);
...
//       if (index === 5) {
//         await axios.post("/api/quiz/updateScore", {
//           submoduleId: params?.submoduleId,
//           score: score * 10,
//         });
//       }
...
//   return (
//     <div className="h-screen flex items-center justify-center gap-20">
//       {showConfetti && <Confetti numberOfPieces={500} friction={0.99} width={1000} height={700} wind={0.5} gravity={0.99} />}
//       <div className="bg-white rounded-2xl shadow-2xl w-[600px] relative p-8">
//         {!showSummary ? (
//           <>
//             <div className="flex justify-between items-center mb-8">
...
//               </div>
//             </div>
//             <h1 className="text-3xl font-bold text-center text-indigo-900 mb-8">{currentQuestion.question}</h1>
//             <div className="grid grid-cols-2 gap-6">
//               {currentQuestion.options.map((option: string, i: number) => (
//                 <button
//                   key={i}
...
//         ) : (
//           <div className="text-center">
//             <h1 className="text-4xl font-bold text-indigo-900 mb-6">Quiz Summary</h1>
//             <p className="text-2xl text-indigo-900 mb-8">Your score is {score}/{questions.length}</p>
//             <div className="flex justify-center gap-6" hidden={params?.submoduleId === undefined}>
//               <button
//                 className="bg-red-500 text-white hover:bg-red-600 font-bold py-3 px-6 rounded-lg shadow-md transition-colors duration-300 ease-in-out transform hover:scale-105"
//                 onClick={handleTryAgain}
//               >
